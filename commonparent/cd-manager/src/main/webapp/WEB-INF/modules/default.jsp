	...
	<form id="form1" >
					...
					<div class="header_tab">
						<ul>
							...
							<li><span class="header_hi">Hi,</span><span
								class="header_usename">友人A</span>！</li>
				...
				<nav>
					<ul id="showMainNav" class="fix">
						<li class="navContent nav_current">
							...
							data-url="${pageContext.request.contextPath}/user/userManage">用户管理</a>
							<%--data-url="./Modules/User/UserManage.html">用户管理</a>--%>
						</li>
						<li class="navContent">
							<a href="#" class="showNav" id="finance" data-name="main_iframe"
							onclick="Common.switchNavigation(this);"
							data-url="${pageContext.request.contextPath}/salary/salaryManage">工资管理</a>
		...
		<div id="main_iframe"
			...
			<iframe class="main_iframe" id="home_iframe" frameborder="0"
				border="0" src="${pageContext.request.contextPath}/user/userManage"></iframe>
				<%--border="0" src="User/UserManage.html"></iframe>--%>
		</div>
